...
public class StoreScreen extends JFrame {
    ...
    JMenuBar createMenuBar() {
        ...
        addBookItem.addActionListener(e -> new AddBookToStoreScreen(store).show());
    
        JMenuItem addCDItem = new JMenuItem("Add CD");
        addCDItem.addActionListener(e -> new AddCompactDiscToStoreScreen(store).show());
    
        JMenuItem addDVDItem = new JMenuItem("Add DVD");
        addDVDItem.addActionListener(e -> new AddDigitalVideoDiscToStoreScreen(store).show());
    ...
    // Chuyển sang màn hình Cart khi nhấn "View Cart"
    ...
    public static void main(String[] args) {
        ...
        Cart cart = new Cart(store);  // Tạo đối tượng Cart
